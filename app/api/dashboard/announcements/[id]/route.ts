...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  await logMutation({ tenantId: session.tenantId, action: 'update', resource: 'announcement', resourceId: params.id, userId: session.uid })
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  await logMutation({ tenantId: session.tenantId, action: 'delete', resource: 'announcement', resourceId: params.id, userId: session.uid })
